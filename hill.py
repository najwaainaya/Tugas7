...
def cipher_encryption():
  #mendenifisikan variable msg sebagai inputan
    msg = input("Masukkan Pesan: ").upper()
    msg = msg.replace(" ", "")
    ...
    key = input("Masukkan String Kunci 4 Huruf: ").upper()
    key = key.replace(" ", "")
    ...
    # if else
    # print hasil
    print("Teks Enkripsi: {}".format(encryp_text))
...
def cipher_decryption():
    ...
    print("Teks Dekripsi: {}".format(decryp_text))

# menu untuk memilih no 1 untuk enkripsi no 2 untuk dekripsi
def main():
    choice = int(input("1. Enkripsi\n2. Dekripsi\nMemilih(1,2): "))
    if choice == 1:
        print("---Enkripsi---")
        cipher_encryption()
    elif choice == 2:
